...
import com.android.cameraclone.app.CameraAppUI.BottomBarUISpec;
import com.android.cameraclone.app.LocationManager;
import com.android.cameraclone.app.OrientationManager.DeviceOrientation;
import com.android.cameraclone.async.MainThread;
import com.android.cameraclone.burst.BurstFacade;
import com.android.cameraclone.burst.BurstFacadeFactory;
import com.android.cameraclone.burst.BurstReadyStateChangeListener;
import com.android.cameraclone.burst.OrientationLockController;
import com.android.cameraclone.captureintent.PreviewTransformCalculator;
import com.android.cameraclone.debug.DebugPropertyHelper;
import com.android.cameraclone.debug.Log;
import com.android.cameraclone.debug.Log.Tag;
import com.android.cameraclone.device.CameraId;
import com.android.cameraclone.hardware.HardwareSpec;
import com.android.cameraclone.hardware.HeadingSensor;
import com.android.cameraclone.module.ModuleController;
import com.android.cameraclone.one.OneCamera;
import com.android.cameraclone.one.OneCamera.AutoFocusState;
import com.android.cameraclone.one.OneCamera.CaptureReadyCallback;
import com.android.cameraclone.one.OneCamera.Facing;
import com.android.cameraclone.one.OneCamera.OpenCallback;
import com.android.cameraclone.one.OneCamera.PhotoCaptureParameters;
import com.android.cameraclone.one.OneCameraAccessException;
...
import com.android.cameraclone.one.v2.photo.ImageRotationCalculatorImpl;
import com.android.cameraclone.remote.RemoteCameraModule;
...
import com.android.cameraclone.stats.CaptureStats;
...
import com.android.cameraclone.ui.CountDownView;
import com.android.cameraclone.ui.PreviewStatusListener;
import com.android.cameraclone.ui.TouchCoordinate;
import com.android.cameraclone.ui.focus.FocusController;
import com.android.cameraclone.ui.focus.FocusSound;
