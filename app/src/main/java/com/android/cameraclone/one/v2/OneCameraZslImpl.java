...
import com.android.cameraclone.CaptureModuleUtil;
...
import com.android.cameraclone.one.AbstractOneCamera;
import com.android.cameraclone.one.CameraDirectionProvider;
import com.android.cameraclone.one.OneCamera;
import com.android.cameraclone.one.OneCamera.PhotoCaptureParameters.Flash;
import com.android.cameraclone.one.Settings3A;
import com.android.cameraclone.one.v2.ImageCaptureManager.ImageCaptureListener;
import com.android.cameraclone.one.v2.ImageCaptureManager.MetadataChangeListener;
import com.android.cameraclone.one.v2.camera2proxy.AndroidCaptureResultProxy;
import com.android.cameraclone.one.v2.camera2proxy.AndroidImageProxy;
import com.android.cameraclone.one.v2.camera2proxy.CaptureResultProxy;
import com.android.cameraclone.processing.imagebackend.TaskImageContainer;
import com.android.cameraclone.session.CaptureSession;
import com.android.cameraclone.ui.focus.LensRangeCalculator;
import com.android.cameraclone.ui.motion.LinearScale;
import com.android.cameraclone.util.CameraUtil;
import com.android.cameraclone.util.ExifUtil;
import com.android.cameraclone.util.JpegUtilNative;
import com.android.cameraclone.util.ListenerCombiner;
...
public class OneCameraZslImpl extends AbstractOneCamera {
    ...
    /**
     * @see com.android.cameraclone.one.OneCamera#triggerFocusAndMeterAtPoint(float,
     *      float)
     */
    @Override
