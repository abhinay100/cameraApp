...
package com.android.cameraclone.one.v2.sharedimagereader.imagedistributor;
 ...
 * {@link com.android.cameraclone.one.v2.core.RequestBuilder} to then get Images
...
public interface ImageStream extends BufferQueue<ImageProxy>, CaptureStream {
     ...
     *             image.
     * @throws com.android.cameraclone.async.BufferQueue.BufferQueueClosedException
