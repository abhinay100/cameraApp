...
public interface ModuleManager {
    ...
    public static interface ModuleAgent {
         ...
         * Creates the module.
         *
         * @param app The {@link com.android.cameraclone.app.AppController} which
         *            creates this module.
     ...
     *
     * @param agent The {@link com.android.cameraclone.app.ModuleManager.ModuleAgent}
     *              of the module.
     ...
     * {@link com.android.cameraclone.app.ModuleManager.ModuleAgent} of all the
     * registered modules.
     */
    ...
    /**
     * Returns the {@link com.android.cameraclone.app.ModuleManager.ModuleAgent} by
     * the module ID.
     *
     * @param moduleId The module ID.
     * @return The agent.
