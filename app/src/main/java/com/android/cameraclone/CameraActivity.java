...
package com.android.cameraclone;
...
import com.android.cameraclone.app.CameraAppUI;
import com.android.cameraclone.app.CameraController;
import com.android.cameraclone.app.CameraProvider;
import com.android.cameraclone.app.CameraServices;
import com.android.cameraclone.app.CameraServicesImpl;
import com.android.cameraclone.app.FirstRunDialog;
import com.android.cameraclone.app.LocationManager;
import com.android.cameraclone.app.MemoryManager;
import com.android.cameraclone.app.MemoryQuery;
import com.android.cameraclone.app.ModuleManager;
import com.android.cameraclone.app.ModuleManager.ModuleAgent;
import com.android.cameraclone.app.ModuleManagerImpl;
import com.android.cameraclone.app.MotionManager;
import com.android.cameraclone.app.OrientationManager;
import com.android.cameraclone.app.OrientationManagerImpl;
import com.android.cameraclone.data.CameraFilmstripDataAdapter;
import com.android.cameraclone.data.FilmstripContentObserver;
import com.android.cameraclone.data.FilmstripItem;
import com.android.cameraclone.data.FilmstripItemData;
import com.android.cameraclone.data.FilmstripItemType;
import com.android.cameraclone.data.FilmstripItemUtils;
import com.android.cameraclone.data.FixedLastProxyAdapter;
import com.android.cameraclone.data.GlideFilmstripManager;
import com.android.cameraclone.data.LocalFilmstripDataAdapter;
import com.android.cameraclone.data.LocalFilmstripDataAdapter.FilmstripItemListener;
import com.android.cameraclone.data.MediaDetails;
import com.android.cameraclone.data.MetadataLoader;
import com.android.cameraclone.data.PhotoDataFactory;
import com.android.cameraclone.data.PhotoItem;
import com.android.cameraclone.data.PhotoItemFactory;
import com.android.cameraclone.data.PlaceholderItem;
import com.android.cameraclone.data.SessionItem;
import com.android.cameraclone.data.VideoDataFactory;
import com.android.cameraclone.data.VideoItemFactory;
import com.android.cameraclone.debug.Log;
import com.android.cameraclone.device.ActiveCameraDeviceTracker;
import com.android.cameraclone.device.CameraId;
import com.android.cameraclone.filmstrip.FilmstripContentPanel;
import com.android.cameraclone.filmstrip.FilmstripController;
import com.android.cameraclone.module.ModuleController;
import com.android.cameraclone.module.ModulesInfo;
import com.android.cameraclone.one.OneCameraException;
import com.android.cameraclone.one.OneCameraManager;
import com.android.cameraclone.one.OneCameraModule;
import com.android.cameraclone.one.OneCameraOpener;
import com.android.cameraclone.one.config.OneCameraFeatureConfig;
import com.android.cameraclone.one.config.OneCameraFeatureConfigCreator;
import com.android.cameraclone.session.CaptureSession;
import com.android.cameraclone.session.CaptureSessionManager;
import com.android.cameraclone.session.CaptureSessionManager.SessionListener;
import com.android.cameraclone.settings.AppUpgrader;
import com.android.cameraclone.settings.CameraSettingsActivity;
import com.android.cameraclone.settings.Keys;
import com.android.cameraclone.settings.PictureSizeLoader;
import com.android.cameraclone.settings.ResolutionSetting;
import com.android.cameraclone.settings.ResolutionUtil;
import com.android.cameraclone.settings.SettingsManager;
import com.android.cameraclone.stats.UsageStatistics;
import com.android.cameraclone.stats.profiler.Profile;
import com.android.cameraclone.stats.profiler.Profiler;
import com.android.cameraclone.stats.profiler.Profilers;
import com.android.cameraclone.tinyplanet.TinyPlanetFragment;
import com.android.cameraclone.ui.AbstractTutorialOverlay;
import com.android.cameraclone.ui.DetailsDialog;
import com.android.cameraclone.ui.MainActivityLayout;
import com.android.cameraclone.ui.ModeListView;
import com.android.cameraclone.ui.ModeListView.ModeListVisibilityChangedListener;
import com.android.cameraclone.ui.PreviewStatusListener;
import com.android.cameraclone.util.ApiHelper;
import com.android.cameraclone.util.Callback;
import com.android.cameraclone.util.CameraUtil;
import com.android.cameraclone.util.GalleryHelper;
import com.android.cameraclone.util.GcamHelper;
import com.android.cameraclone.util.GoogleHelpHelper;
import com.android.cameraclone.util.IntentHelper;
import com.android.cameraclone.util.PhotoSphereHelper.PanoramaViewHelper;
import com.android.cameraclone.util.QuickActivity;
import com.android.cameraclone.util.ReleaseHelper;
import com.android.cameraclone.widget.FilmstripView;
import com.android.cameraclone.widget.Preloader;
